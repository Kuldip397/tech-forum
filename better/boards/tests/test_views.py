...
class HomeTests(TestCase):
    ...
    def test_home_view_contains_link_to_topics_page(self):
        ...
        self.assertContains(
            self.response, 'href="{}"'.format(board_topics_url))
...
class NewTopicTests(TestCase):
    def setUp(self): 
        ...
        User.objects.create_user(username='kuldipkumar', email='temp@foo.com', password='123')
    ...
    def test_new_topic_invalid_post_data(self):
        '''
            Invalid post shouln't be redirected
        '''
        url = reverse('new_topic', kwargs={'pk':1})
